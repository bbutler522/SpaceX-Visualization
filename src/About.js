  ...
  render() {
    return (
      <div>
        ...
        <p className="alert alert-info">Work in progress, some content is still being built and a lot of improvements to follow. Track updates on <a href="https://github.com/bbutler522/SpaceX-Visualization">GitHub</a>.</p>
